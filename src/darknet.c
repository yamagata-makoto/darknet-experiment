...
extern void run_pose(int argc, char **argv);
extern void run_face(int argc, char **argv);
extern void run_face_cv(int argc, char **argv);
...
int main(int argc, char **argv)
{
    ...
    if (0 == strcmp(argv[1], "average")){
        ...
        run_coco(argc, argv);
    } else if (0 == strcmp(argv[1], "pose")){
        run_pose(argc, argv);
    } else if (0 == strcmp(argv[1], "face")){
        run_face(argc, argv);
    } else if (0 == strcmp(argv[1], "facecv")){
        run_face_cv(argc, argv);
